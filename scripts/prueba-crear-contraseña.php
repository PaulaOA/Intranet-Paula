...
#btnModalClaveCreada, #btnModalErrorClave { 
  background-color: #007bff; /* Color de fondo del botón */
  color: #fff; /* Color del texto del botón */
  border: none; /* Eliminar el borde del botón */
  border-radius: 4px; /* Añadir bordes redondeados al botón */
...
<main class="main" style="text-align: center;">
  ...
  <script>
    $(document).ready(function(){
      ...
      $(".close, #btnModalClaveCreada, #btnModalErrorClave").click(function(){
        $("#modalClaveCreada, #modalErrorClave").css("display", "none");
...
<div id="modalClaveCreada" class="modal">
  <div class="modal-content">
    ...
    <p>Ya puedes introducir tus datos apra iniciar sesión</p>
