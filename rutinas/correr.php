...
<div class="contenedor" id="contenedorCorrer">
...
<<!-- MENÚ LATERAL-->
 <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
  ...
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    <h1 class="text-body-emphasis">Cardio (correr)</h1>
...
<script>
      $(document).ready(function(){
        $("#btnInicio").click(function(e){
          e.preventDefault();
            $("#contenedorCorrer").load("../pagina-usuario.php", function(){
              history.pushState(null,null,"../pagina-usuario.php");
            });
            window.onpopstate = function(event){
            $("#contenedorInicio").load("correr.php");
          };
        });
      });
  ...
  <script>
    $(document).ready(function(){
      $("#btnRutinas").click(function(e){
        e.preventDefault();
         $("#contenedorCorrer").load("rutinas.php", function(){
                history.pushState(null,null,"rutinas.php");
              });
              window.onpopstate = function(event){
              $("#contenedorRutinas").load("correr.php");
            };
          });
        });
      ...
      $("#btnCerrarSesion").click(function(e){
          ...
          $.ajax({
              ...
              success: function(data){
                  $("#contenedorCorrer").load("../pagina-inicio.php", function(){
