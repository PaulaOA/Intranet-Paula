...
<div class="contenedor" id="contenedorEspalda">
...
<main class="d-flex flex-nowrap">
 ...
 <!-- MENÚ LATERAL-->
  ...
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    <h1 class="text-body-emphasis">Tren superior (espalda)</h1>
...
<script>
      $(document).ready(function(){
        $("#btnInicio").click(function(e){
          e.preventDefault();
            $("#contenedorEspalda").load("../pagina-usuario.php", function(){
              history.pushState(null,null,"../pagina-usuario.php");
            });
            window.onpopstate = function(event){
            $("#contenedorInicio").load("espalda.php");
          };
        });
      });
  ...
  <script>
    $(document).ready(function(){
      $("#btnRutinas").click(function(e){
        e.preventDefault();
         $("#contenedorEspalda").load("rutinas.php", function(){
                history.pushState(null,null,"rutinas.php");
              });
              window.onpopstate = function(event){
              $("#contenedorRutinas").load("espalda.php");
            };
          });
        });
      ...
      $("#btnCerrarSesion").click(function(e){
          ...
          $.ajax({
              ...
              success: function(data){
                  $("#contenedorEspalda").load("../pagina-inicio.php", function(){
