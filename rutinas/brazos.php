...
<div class="contenedor" id="contenedorBrazos">
...
<!-- MENÚ LATERAL-->
  ...
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    <h1 class="text-body-emphasis">Brazos</h1>
...
<script>
      $(document).ready(function(){
        $("#btnInicio").click(function(e){
          e.preventDefault();
            $("#contenedorBrazos").load("../pagina-usuario.php", function(){
              history.pushState(null,null,"../pagina-usuario.php");
            });
            window.onpopstate = function(event){
            $("#contenedorInicio").load("brazos.php");
          };
        });
      });
  ...
  <script>
    $(document).ready(function(){
      $("#btnRutinas").click(function(e){
        e.preventDefault();
         $("#contenedorBrazos").load("rutinas.php", function(){
                history.pushState(null,null,"rutinas.php");
              });
              window.onpopstate = function(event){
              $("#contenedorRutinas").load("brazos.php");
            };
          });
        });
      ...
      $("#btnCerrarSesion").click(function(e){
          ...
          $.ajax({
              ...
              success: function(data){
                  $("#contenedorBrazos").load("../pagina-inicio.php", function(){
