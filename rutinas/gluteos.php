...
<div class="contenedor" id="contenedorGluteos">
...
<!-- MENÚ LATERAL-->
  ...
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    <h1 class="text-body-emphasis">Tren inferior (glúteos)</h1>
...
<script>
      $(document).ready(function(){
        $("#btnInicio").click(function(e){
          e.preventDefault();
            $("#contenedorGluteos").load("../pagina-usuario.php", function(){
              history.pushState(null,null,"../pagina-usuario.php");
            });
            window.onpopstate = function(event){
            $("#contenedorInicio").load("gluteos.php");
          };
        });
      });
  ...
  <script>
    $(document).ready(function(){
      $("#btnRutinas").click(function(e){
        e.preventDefault();
         $("#contenedorGluteos").load("rutinas.php", function(){
                history.pushState(null,null,"rutinas.php");
              });
              window.onpopstate = function(event){
              $("#contenedorRutinas").load("gluteos.php");
            };
          });
        });
      ...
      $("#btnCerrarSesion").click(function(e){
          ...
          $.ajax({
              ...
              success: function(data){
                  $("#contenedorGluteos").load("../pagina-inicio.php", function(){
