...
<div class="contenedor" id="contenido-usuario">
...
<main class="main" style="text-align: center;">
  ...
  <form class="form-signin" id="formInicioSesion" method="POST">
    ...
    <a href="#">¿No tienes cuenta aún? Regístrate</a>
  </form>
       ...
       $("#btnAcceso").click(function(event){
         ...
         $.ajax({
           ...
           success: function(response){
            if (response == "usuario") {
              $("#contenido-usuario").load("pagina-usuario.php");
            } else if (response == "admin"){
              $("#contenido-usuario").load("panel-admin.php");
            } else {
